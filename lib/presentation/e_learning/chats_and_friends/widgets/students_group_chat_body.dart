...
import 'package:academic_master/presentation/e_learning/chats_and_friends/widgets/type_message_box.dart';
            ...
            providers: [
              BlocProvider(
                create: (context) => getIt<GroupChatMessageWatcherBloc>()
                  ..add(
                    const GroupChatMessageWatcherEvent.watchGroupChatMessages(),
                  ),
              ),
              BlocProvider(
